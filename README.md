...
**You are viewing the documentation for Mozart 0.6.** This version is **no longer supported**. See [supported versions](https://github.com/coenjacobs/mozart?tab=readme-ov-file#supported-versions) for all available versions and their documentation.
